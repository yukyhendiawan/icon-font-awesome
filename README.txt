...
The Block Plugin: Icon Font Awesome allows you to easily add a Gutenberg block to select icons from the Font Awesome collection.
...
3. Search for "Block: Icon Font Awesome":
-On the Add Plugin page, locate the search box in the top right corner.
-Type "Block: Icon Font Awesome" in the search box.
4.Install the Plugin:
-After finding the "Block: Icon Font Awesome" plugin, click the "Install" button below it.
...
Contributions are always open to those who wish to participate in the further development of this plugin. [Github](https://github.com/yukyhendiawan/icon-font-awesome).
