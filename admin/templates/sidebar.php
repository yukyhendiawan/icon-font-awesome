...
<div class="about-me box-sidebar">
	<h3><?php esc_html_e( 'About Developer', 'icon-font-awesome' ); ?></h3>
	<img class="developer" src="<?php echo esc_url( plugins_url( 'icon-font-awesome' ) . '/assets/images/yukyhendiawan.jpg' ); ?>" alt="about developer">
	<p class="desc"><?php esc_html_e( "Hello, I'm Yuky Hendiawan, an experienced WordPress developer with over 5 years of expertise.", 'icon-font-awesome' ); ?></p>
	<p class="desc"><?php esc_html_e( 'As a Freelancer, I am actively engaged in a variety of WordPress development projects.', 'icon-font-awesome' ); ?></p>
	<p class="desc"><?php esc_html_e( 'My expertise includes creating plugins, designing custom themes, tailoring both plugins and themes to meet specific requirements.', 'icon-font-awesome' ); ?></p>
	<p class="desc"><?php esc_html_e( 'If you need a WordPress developer, feel free to contact me.', 'icon-font-awesome' ); ?></p>
	<p class="desc"><?php esc_html_e( 'Contact:', 'icon-font-awesome' ); ?></p>
		...
		<ul>
			<li>
				<a style="color: #0060f3;" rel="nofollow noreferrer noopener" href="https://www.upwork.com/freelancers/~01559dc6ef8a329c82" target="_blank">
					...
					<span><?php esc_html_e( 'Upwork', 'icon-font-awesome' ); ?></span>
				</a>
			</li>
			<li>
				<a rel="nofollow noreferrer noopener" href="mailto:yukyhendiawan1998@gmail.com">
					...
					<span><?php esc_html_e( 'yukyhendiawan1998@gmail.com', 'icon-font-awesome' ); ?></span>
				</a>
			</li>
		</ul>
	</div>
